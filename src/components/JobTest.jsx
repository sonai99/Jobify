...
<div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow mt-2 ">
<a href="/jobs">
  
  <h1 class="mb text-2xl font-medium tracking-tight  ">{job.company}</h1>
  <p class="mb text-base font-medium tracking-tight  ">{job.position}</p>

<p class="font-normal   ">{job.role} • {job.location}</p>
<p class="mb-2 font-normal  ">Posted {job.postedAt}</p>
</a>
