...
const Jobs = () => {
  ...
  return (
    <div class=" mb-6 ">
          <h2 class="mb-4 ml-10  max-w-screen-xl text-4xl font-bold mt-4 text-gray-900">Check out our Jobs</h2>
    <div className=' ml-10 grid sm:grid-cols-2 md:grid-cols-4 gap-4 content-evenly sm:px-0'>
